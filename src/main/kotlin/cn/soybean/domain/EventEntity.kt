...
class EventEntity : ReactivePanacheMongoEntity() {
    ...
    override fun toString(): String {
        return "EventEntity(eventType='$eventType', aggregateId='$aggregateId', aggregateType='$aggregateType', version=$version, data=${data.contentToString()}, metaData=${metaData?.contentToString()}, timeStamp=$timeStamp)"
    }
}